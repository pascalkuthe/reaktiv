...
pub use effect_arena::{
    ...
    effect_arena_insert, effect_arena_remove, mark_effect_pending, remove_from_pending_set,
    set_effect_parent, take_pending_effects,
};

// Re-export types from signal_arena
pub use signal_arena::{
    SignalId, SignalMetadata, signal_arena_insert, signal_arena_remove, with_signal_arena,
};
